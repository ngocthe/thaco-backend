<table>
    <tr><th style="font-weight: bold" colspan="5"><h3>Orders List</h3></th></tr>
</table>

<table style="border: 1px solid black; border-collapse: collapse; width: 100%">
    <thead>
    <tr>
        <th style="font-weight: bold; border: 1px solid black; border-collapse: collapse; width: 30px">No.</th>
        ...
        <th style="font-weight: bold; border: 1px solid black; border-collapse: collapse; width: 100px">MOQ</th>
        <th style="font-weight: bold; border: 1px solid black; border-collapse: collapse; width: 100px">Number of quantity from MRP Results</th>
        <th style="font-weight: bold; border: 1px solid black; border-collapse: collapse; width: 100px">Actual Order Quantity</th>
    ...
    @foreach($orderLists as $index => $order)
        <tr>
            ...
            <td style="border: 1px solid black; border-collapse: collapse; text-align: left">{{ $order['moq'] }}</td>
            <td style="border: 1px solid black; border-collapse: collapse; text-align: left">{{ number_format($order['mrp_quantity']) ?: '' }}</td>
