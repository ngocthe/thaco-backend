...
class CreateBwhInventoryLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bwh_inventory_logs', function (Blueprint $table) {
            $table->id();
			...
			$table->date("devanned_date")->nullable(true);
			$table->date("stored_date")->nullable(true);
    ...
    {
        Schema::dropIfExists('bwh_inventory_logs');
    }
}
