...
class CreateWarehouseSummaryAdjustmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('warehouse_summary_adjustments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('warehouse_summary_adjustments');
    }
}
