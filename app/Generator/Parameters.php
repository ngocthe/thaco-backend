...
//        'foreign' => 'foreignId'
     ...
     * @throws Exception
     */
    public static function getValidColumnType(string $columnType): string
    {
     ...
     * @return array
     */
    public static function getParameters(string $columnType): array
    {
     ...
     * @return array|string
     */
    public static function getModifierParameters(string $modifier): array
    {
     ...
     * @return array
     */
    private static function normalizedTypes(): array
    {
     ...
     * @return array
     */
    private static function normalizedAliases(): array
    {
