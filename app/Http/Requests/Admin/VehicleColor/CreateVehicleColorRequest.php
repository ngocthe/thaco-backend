...
/**
 * @OA\Schema(
 *     title="Create vehicle color request",
 *     type="object",
 *     required={"code", "type", "name", "ecn_in", "plant_code"}
 * )
 */
class CreateVehicleColorRequest extends BaseApiRequest
{
    /**
     * @var array
     */
    ...
    {
        return [
            'code' => 'bail|required|alpha_num_dash|min:1|max:4|unique:vehicle_colors,code,NULL,code,deleted_at,NULL,ecn_in,' . $this->get('ecn_in') . ',plant_code,' . $this->get('plant_code'),
